        ...
        <div class="col-lg-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <img src="{{asset('ui/backend/images/icon.png')}}" alt="blood icon">
                        </div>
                        <div class="col-md-6">
                            <div class="text-left">
                                <h3>206</h3>
                                ...
                                <tbody>
                                        ...
                                        <td class="avatar">
                                            <div class="round-img">
                                                <a href="#"><img class="rounded-circle"
                                                        src="{{asset('ui/backend/images/avatar/1.jpg')}}" alt=""></a>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="avatar">
                                            <div class="round-img">
                                                <a href="#"><img class="rounded-circle"
                                                        src="{{asset('ui/backend/images/avatar/2.jpg')}}" alt=""></a>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="avatar">
                                            <div class="round-img">
                                                <a href="#"><img class="rounded-circle"
                                                        src="{{asset('ui/backend/images/avatar/3.jpg')}}" alt=""></a>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="avatar">
                                            <div class="round-img">
                                                <a href="#"><img class="rounded-circle"
                                                        src="{{asset('ui/backend/images/avatar/4.jpg')}}" alt=""></a>
                                            </div>
                                        </td>
                                    ...
                                    <tr class=" pb-0">
                                        ...
                                        <td class="avatar pb-0">
                                            <div class="round-img">
                                                <a href="#"><img class="rounded-circle"
                                                        src="{{asset('ui/backend/images/avatar/6.jpg')}}" alt=""></a>
                                            </div>
                                        </td>
