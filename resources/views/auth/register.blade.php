...
<head>
    ...
    <!-- Theme title-->
    <title>Blood Track | Login Page</title>
...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Blood Tracker Register') }}</div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    <p>If You Have An Account! Log In <a href="{{route('login')}}">Here...</a></p>
    ...
    <!-- REQUIRED SCRIPTS -->
    <script type="text/javascript" src="{{asset('js/jQuery-v2.2.4.js')}}"></script>
